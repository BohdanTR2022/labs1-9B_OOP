class Main {
    ...
    public static void task5() {
        ExtendedStudentGroup group = new ExtendedStudentGroup();
        group.inputData();
        group.setAdditionalFields("Additional Info 1", "Additional Info 2");
        group.displayData();
        System.out.println("Відсоток чоловіків студентів: " + group.calculateMalePercentage() + "%");
        System.out.println("Відсоток жінок студенток: " + group.calculateFemalePercentage() + "%");
    }
}
